...
RES has excess level of encryption, and should be used in specific tasks, where you need absolute encryption and ready to sacrifice your perfomance. If you need perfomance, advise you to use [AES](https://github.com/vladimirrogozin/AES_Implementation).
