...
#include "../RedLibrary/RedEncryptionAlgorithms/ResECB1536.h"
...
int main() {
    ...
    std::string *EncryptedStr = Red::EncryptResECB1536(in, key);
    ...
    std::string *Decrypted  = Red::DecryptResECB1536(*ForDecrypt, key);
